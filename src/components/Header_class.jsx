      ...
      <div class=" h-16 flex text-wrap w-full rounded-md shadow-lg bg-white">
        <div class=" w-26">
          <a class="h-16 w-5/6 " href="">
            <img
              class="h-10 w-6/6 mt-2 rounded-lg "
              src="/new_logo_2.svg"
              alt="GearPro_Logo"
            />
          </a>
        ...
        <div class=" h-10 w-3/6 mt-2 flex ">
          <div class="h-10 w-2/6 grid place-content-center rounded-lg hover:bg-blue-800  pl-5 hover:text-white shadow-md">
            <a class=" mt-1 ml w-2/6   grid place-content-center h-screen">
